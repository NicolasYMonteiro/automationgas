-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ATENDENTE', 'ADMINISTRATIVO');

-- CreateEnum
CREATE TYPE "PaymentType" AS ENUM ('DINHEIRO', 'CARTAO', 'PIX', 'FIADO');

-- CreateEnum
CREATE TYPE "SaleStatus" AS ENUM ('COMPLETED', 'PENDING', 'CANCELLED');

-- CreateEnum
CREATE TYPE "ExpenseCategory" AS ENUM ('COMBUSTIVEL', 'MANUTENCAO', 'ALIMENTACAO', 'OUTROS');

-- CreateEnum
CREATE TYPE "InventoryType" AS ENUM ('ENTRADA', 'SAIDA', 'AJUSTE');
